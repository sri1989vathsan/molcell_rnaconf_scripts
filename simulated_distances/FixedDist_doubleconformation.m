function [] = FixedDist_doubleconformation(dist1,values1,dist2,values2)
% dis = 200; 
% values = 1000;
[x1] = randfixedsum(3,values1,dist1^2,0,dist1^2);
[x2] = randfixedsum(3,values2,dist2^2,0,dist2^2);
% figure(11)
...
% [n1,xout1] = hist(sqrt(x1(1,:)),100);
% figure(1)
% bar(xout1,n1*100/sum(n1))
% xlabel('X value');
% ylabel('Percentage of samples');
% 
% [n2,xout2] = hist(sqrt(x1(2,:)),100);
% figure(2)
% bar(xout2,n2*100/sum(n2))
% xlabel('Y value');
% ylabel('Percentage of samples');
% 
% [n3,xout3] = hist(sqrt(x1(3,:)),100);
% figure(3)
